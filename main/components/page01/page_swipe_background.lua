...
------------------------------------------------
--
local bgW, bgH = 1280/4, 1920/4                 --  layer.background.width, layer.background.height
local pgX, pgY = _K.ultimatePosition(640, 960) --  layer.background.x, layer.background.y
...
if layer.background == nil then return end
  local W, H = layer.background.width, layer.background.height
